...
import br.feevale.projetofinal.model.pagamento.PagamentoCartao;
import br.feevale.projetofinal.model.pagamento.PagamentoDinheiro;
import br.feevale.projetofinal.model.pagamento.PagamentoPix;
...
public class TelaPagamentoController {
    ...
    private void irParaTelaConfirmacao(FormaPagamento formaPagamento) {
        try {
            ...
            // Passa informações para a tela de confirmação
